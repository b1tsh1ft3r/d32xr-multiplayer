...
#ifdef MARS
		if (currentplaymode == 0) { print(118, m_doom->height+22, "Single"); }
		if (currentplaymode == 1) { print(118, m_doom->height+22, "Co-op"); }
		if (currentplaymode == 2) { print(118, m_doom->height+22, "Deathmatch"); }
#else
